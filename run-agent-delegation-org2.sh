...
# Complete workflow for Organization 2 (Buyer Company) agent delegation
# This assumes GEDA, QVI, LE, and OOR Holder are already set up

set -e

echo "=========================================="
echo "ORGANIZATION 2: BUYER COMPANY"
echo "Agent Delegation Workflow"
echo "=========================================="

# Configuration
OOR_HOLDER_NAME="Tommy_Buyer_OOR"
AGENT_NAME="tommyBuyerAgent"
LE_NAME="Buyer_Company_LE"
...
echo ""
echo "=========================================="
echo "✓ ORGANIZATION 2 AGENT DELEGATION COMPLETE"
echo "=========================================="
echo ""
echo "Agent Summary:"
